...
namespace Modules\Indexing\Entities;
...
use Modules\Indexing\Events\IndexingCreated;
use Modules\Indexing\Events\IndexingDeleted;
use Modules\Indexing\Events\IndexingUpdated;
use Modules\Indexing\Notifications\IndexingCommented;
use Modules\Indexing\Observers\IndexingObserver;
use Modules\Indexing\Scopes\IndexingScope;
...
class Indexing extends Model
{
    ...
    {
        $max          = \App\Entities\Category::indexing()->max('order');
    ...
    {
        $score     = 0;
        $allStages = Category::whereModule('indexing')->orderBy('order', 'asc')->get();
