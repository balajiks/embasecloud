...
/*-----------------------------------------------------------------------------------------------------------*/
        $('#createSection').on('submit', function(e) {
            ...
            axios.post('{{ route('indexing.api.savesection') }}', data)
	...
	$('.section-list').on('click', '.editSection', function (e) {
		...
		axios.get('{{ get_option("site_url") }}api/v1/indexing/getsectiondata/'+id, {
          "id": id
        })
		.then(function (response) {
	...
	$('.section-list').on('click', '.deleteSection', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexing/'+id+'/sectionindex', {
               id: id,
            })
            .then(function (response) {
				...
				$("#indexer_section").select2({
					maximumSelectionLength: @langapp('sectioncnt') - 1
				});
				$('#indexer_section').val();	
				if(response.data.count == @langapp('sectioncnt')){
					$("#indexer_section").addClass("disabled");
...
/*-----------------------------------------------------------------------------------------------------------*/
	...
	function deleteClassification(classval,id){
		...
		$("#preloaderloading").show();
		axios.post('{{ get_option("site_url") }}api/v1/indexing/deleteclassification', {
			id: id,
			data: classval,
		})
		.then(function (response) {
	...
	$('.section-list').on('click', '.sectionajax', function (e) {
		...
		if(sectionlistId !='') {
			axios.post('{{ get_option('site_url') }}api/v1/indexing/ajax/getclassificationdetails', {
				id: sectionlistId
			})
			.then(function (response) {
				$("#preloader").hide();
...
/*-----------------------------------------------------------------------------------------------------------*/		
		...
		$('#createMedical').on('submit', function(e) {
			if(($("#txtmedicalterm").val() !='') || ($("input[name='hide_mmtct']").is(":checked") == true)){
				...
				axios.post('{{ route('indexing.api.savemedical') }}', data)
				.then(function (response) {
					if(response.data.success == true){
		...
		$('#major-mediallistdata').on('click', '.deletemedicalterm', function (e) {
			...
			axios.delete('{{ get_option("site_url") }}api/v1/indexing/'+id+'/medicaltermindex', {
               id: id,
            })
            .then(function (response) {
					$("#medchecktagtotalajax").html(response.data.checktagcount);
		...
		$('#diseases-listdata').on('click', '.deletemedicalterm', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexing/'+id+'/'+jobid+'/'+orderid+'/medicaltermindex', {
                    id: id,
					jobid: jobid,
					orderid: orderid,
            })
		...
		$('.medical-list').on('click', '.deletechecktag', function (e) {
			...
			$("#preloader").show();
			axios.delete('{{ get_option("site_url") }}api/v1/indexing/'+id+'/medicalchecktagtermindex', {
               id: id,
            })
            .then(function (response) {
...
$('.medical-list').on('click', '.editMedical', function (e) {
	...
	medical = $(this);
	id = medical.data('medical-id');
	axios.get('{{ get_option("site_url") }}api/v1/indexing/getmedicaldata/'+id, {
	  "id": id
	})
	.then(function (response) {
...
$('.drug-list').on('click', '.editDrug', function (e) {
	...
	.catch(function (error) {
		...
		$('#createDrugLinks').on('submit', function(e) {
            ...
            axios.post('{{ route('indexing.api.savedruglinks') }}', data)
            .then(function (response) {
		...
		$('#createDrugTradeName').on('submit', function(e) {
		    ...
		    data = indexerdruglinks.serialize();
            axios.post('{{ route('indexing.api.savedrugtradename') }}', data)
            .then(function (response) {
		...
		$('.drugtradename-list').on('click', '.deletetradeterm', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexing/'+id+'/drugtrademanufacture', {
                    id: id,
            })
            .then(function (response) {
				toastr.success( response.data.message , '@langapp('response_status') ');
		...
		$('#ajaxdrugtradename').on('click', '.deleteajaxtradelink', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexing/'+id+'/'+value+'/deletedrugtradename', {
                    id: id,
					value: value,
            })
            .then(function (response) {
		...
		$('.devicetradename-list').on('click', '.deletetradeterm', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexing/'+id+'/deletemedicaldevicetradename', {
                    id: id,
            })
            .then(function (response) {
				toastr.success( response.data.message , '@langapp('response_status') ');
...
/*-----------------------------------------------------------------------------------------------------------*/		
		...
		$('#createDeviceTradeName').on('submit', function(e) {
            ...
            axios.post('{{ route('indexing.api.savedevicetradename') }}', data)
            .then(function (response) {
		...
		$('#ajaxdevicetradename').on('click', '.deleteajaxtradelink', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexing/'+id+'/'+value+'/deletedevicetradename', {
                    id: id,
					value: value,
            })
            .then(function (response) {
...
/*-----------------------------------------------------------------------------------------------------------*/		
	$('#createCtn').on('submit', function(e) {
            ...
            axios.post('{{ route('indexing.api.savectn') }}', data)
            .then(function (response) {
	...
	$('.ctn-list').on('click', '.deleteCtn', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexing/'+id+'/drugctnindex', {
                    id: id,
            })
            .then(function (response) {
				toastr.success( response.data.message , '@langapp('response_status') ');
...
/*-----------------------------------------------------------------------------------------------------------*/		
	...
	$('#createMedicalIndexing').on('submit', function(e) {
		    ...
		    data = indexerctn.serialize();
            axios.post('{{ route('indexing.api.savemedicalindexing') }}', data)
            .then(function (response) {
	...
	$('#major-mediallistdata').on('click', '.deletemedicaldeviceterm', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexing/'+id+'/'+jobid+'/'+orderid+'/medicaldevicetermindex', {
                    id: id,
					jobid: jobid,
					orderid: orderid,
            })
...
function ajaxdatview(){
	...
	var filepath 	= "{{ get_option('site_url') }}"+"datfileview/"+$('#project_jobid').val()+"_"+$('#project_orderid').val()+"_"+pui+".json";
	axios.post("{{ route('indexing.api.ajaxdatview') }}", {
	...
	$('#tree-data-container').jstree("destroy").empty(); 
        ...
        'core' : {
            'data' : {
			    "url" : "{{ get_option('site_url') }}"+"datfileview/"+$('#project_jobid').val()+"_"+$('#project_orderid').val()+"_"+pui+".json",
                "dataType" : "json" 
				}
        	}
    	});
...
function deleteDiseases(classval,id){
	...
	axios.post('{{ get_option("site_url") }}api/v1/indexing/deletediseases', {
        id: id,
		data: classval,
    })
	.then(function (response) {
