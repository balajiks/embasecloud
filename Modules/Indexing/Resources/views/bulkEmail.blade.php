      ...
      <section class="vbox">
        <header class="header bg-white b-b clearfix">
          <div class="row m-t-sm">
            <div class="col-sm-12 m-b-xs">
              <p class="h3">@langapp('send_email_to_indexing')</p>
            </div>
          </div>
        </header>
        <section class="scrollable wrapper bg">
          <div class="panel panel-body">
            ...
            <header class="panel-heading"><span class="text-dracula">{{ $indexing->count() }} @langapp('indexing')</span></header>
            {!! Form::open(['route' => 'indexing.bulk.send', 'class' => 'bs-example ajaxifyForm', 'data-toggle' => 'validator']) !!}
            
            <div class="panel-body">
              
              <div class="form-group">
                <label class="control-label">@langapp('indexing') @required</label>
