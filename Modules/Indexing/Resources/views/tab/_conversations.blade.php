  ...
  <div class="chat-history">
    <article class="chat-item chat-message clearfix" id="chat-form">
      ...
      <section class="chat-body">
        {!! Form::open(['route' => ['indexing.email', $indexing->id], 'class' => 'bs-example ajaxifyForm m-b-none', 'id' => 'sendMail', 'data-toggle' => 'validator', 'files' => true]) !!}
...
url = '{{ route('indexing.email.delete') }}';
