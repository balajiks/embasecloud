<div class="row">
  <div class="col-lg-12"> {!! Form::open(['route' => 'indexing.api.savemedical', 'id' => 'createMedical', 'class' => 'bs-example form-horizontal m-b-none']) !!}
    <section class="panel panel-default"> @php 
      ...
      <div class="panel-body card">
        ...
        <div class="row">
          <div class="col-md-12">
            <header class="panel-heading" style="padding:10px 0px !important;">
              <header class="btn btn-default btn-sm"> @icon('solid/exclamation-circle') @langapp('medicalalertinfo')  &nbsp;&nbsp;[ <span class="badge badge-warning mr-2">@langapp('medicalinfo') </span> ]</header>
            </header>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-sm">{!!  renderAjaxButtonSquare('save')  !!}  </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
...
if(data == 'show'){
	$('#txtmedicalterm').keyup(function(){  
	   ...
	   if(keyvalue !='') {
			axios.post('{{ get_option('site_url') }}api/v1/indexing/ajax/terms', {
				searchterm: keyvalue,
				searchtype: 'medical',
				suggestion: data,
			})
