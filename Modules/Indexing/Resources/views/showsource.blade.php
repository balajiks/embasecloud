...
<li id="elsevierterm" data-jstree={"icon":"'.$foldericon.'"}>Elsevier Term
          ...
          <li class="panel btn-default" id="tokenize" style="height:40px;">
            <div class=tab-container>
              <ul class="tabs clearfix" >
                <li> <a href=# >@icon('solid/cogs') &nbsp;<span class="btn btn-default btn-xs"><strong>JobID: {{ $jobsourceinfo[0]->id }}</strong></span> &nbsp;&nbsp; <span class="btn btn-default btn-xs"><strong>PUI: {{ $jobsourceinfo[0]->pui }}</strong></span> </a> </li>
              </ul>
            </div>
          </li>
        </ul>
  ...
  {{ get_option('site_url') }}../storage/app/uploads/projects/{{ $jobsourceinfo[0]->filename }}
  <?php /*?>
  //var myPDF = PDFObject.embed("<?php //echo   (string) $request->getUri();?>", "#pdf", options);
