...
<div class="wrapper b-b b-light">
    ...
    <a href="{{ route('indexing.emails', ['id' => $email->id, 'action' => 'delete'])  }}" data-toggle="ajaxModal" class="pull-right text">@svg('solid/trash-alt')
    </a>
            ...
            <div class="padder">
                <div class="panel bg-light">
                    <div class="panel-body">
                        ...
                        {!! Form::open(['route' => 'indexing.emailReply', 'class' => 'm-b-none ajaxifyForm', 'novalidate']) !!}
