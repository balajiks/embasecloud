...
abstract class IndexingsController extends Controller
{
	...
	public function showemtree($id){
		...
		return view('indexings::showemtree')->with($data);
	}
	...
	public function ajaxapivalidation($id){
        ...
        return view('indexings::modal.showopsbank')->with($data);
