...
Route::group(
    ...
    function () {
       ...
       // Route::get('artisan/{key}/{command}', 'CommandsController@run')->name('commands.run')->middleware('demo');
	    Route::get('artisan/{key}/{command}', 'CommandsController@run')->name('commands.run')->middleware('can:menu_settings');
        Route::get('artisan/regenerate', 'CommandsController@regenerateKey')->name('commands.key')->middleware('can:settings_update');
