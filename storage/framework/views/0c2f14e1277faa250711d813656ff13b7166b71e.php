                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check text-muted">
                                        <label>
                                            <input type="checkbox" name="profile[channels][whatsapp]" <?php echo e(in_array('whatsapp', $channels) ? 'checked' : ''); ?>> <span class="label-text"><?php echo trans('app.'.'receive_whatsapp_notification'); ?> <a href="<?php echo e(route('whatsapp.subscribe')); ?>" class="btn btn-xs btn-success" data-toggle="ajaxModal"><?php echo trans('app.'.'subscribe'); ?></a> </span>
                                        </label>
                                    </div>
                                    <?php endif; ?>
