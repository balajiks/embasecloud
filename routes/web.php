...
/* Spark Route Starts */
//Route::any('logout', ['as'=>'logout', 'uses'=>'Auth\TokensController@clearToken']);
//Route::any('/authLogin', 'Auth\TokensController@authLogin');
//Route::any('error', 'Auth\TokensController@loginError');
/* Spark Route Ends */